                        ...
                        <div className="prose prose-lg text-sm text-stone-600 gap-y-3 flex flex-col">
                            <div className="mx-auto">
                                <section className="mb-8">
                                    <h2 className="text-xl mb-4">1. Account Registration</h2>
                                ...
                                <section className="mb-8">
                                    <h2 className="text-xl mb-4">2. Financial Transactions</h2>
                                    <p className="text-stone-700 mb-2">
                                ...
                                <section className="mb-8">
                                    <h2 className="text-xl mb-4">3. Fees and Charges</h2>
                                    <p className="text-stone-700 mb-2">
                                ...
                                <section className="mb-8">
                                    <h2 className="text-xl mb-4">4. Liability and Indemnification</h2>
                                    <p className="text-stone-700 mb-2">
                                ...
                                <section className="mb-8">
                                    <h2 className="text-xl mb-4">5. Governing Law</h2>
                                    <p className="text-stone-700 mb-2">
                                ...
                                <section>
                                    <h2 className="text-xl mb-4">6. Amendments</h2>
                                    <p className="text-stone-700 mb-2">
